...
\restrict NWWw64v2qoTIefrTj37QQca8HmnoNRyzmBBQJdxyYW8JhcLqxEcGe0hMxhKqHfc
...
--
-- Name: LatestSession; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."LatestSession" (
    id integer NOT NULL,
    selected_players jsonb DEFAULT '[]'::jsonb NOT NULL,
    clusters jsonb DEFAULT '[]'::jsonb NOT NULL,
    team_a_name text DEFAULT 'Falchi'::text NOT NULL,
    team_b_name text DEFAULT 'Aquile'::text NOT NULL,
...
--
-- Name: Risultati; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public."Risultati" (
    ...
    team_b_players jsonb DEFAULT '[]'::jsonb NOT NULL,
    risultato text,
    marcatori_a jsonb DEFAULT '[]'::jsonb NOT NULL,
    marcatori_b jsonb DEFAULT '[]'::jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    "Stadium" text DEFAULT 'Six Fingers'::text
);


--
-- Name: Risultati_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."Risultati_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: Risultati_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."Risultati_id_seq" OWNED BY public."Risultati".id;
...
CREATE TABLE public."SiteSettings" (
    id integer NOT NULL,
    match_label text DEFAULT 'Venerdì 19 giugno - Ore 21'::text NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.classifica (
    id integer NOT NULL,
    nome text NOT NULL,
    pt_partita numeric(5,2) DEFAULT 0 NOT NULL,
    partite_giocate integer DEFAULT 0 NOT NULL,
    punti_assoluti integer DEFAULT 0 NOT NULL,
    gol_fatti integer DEFAULT 0 NOT NULL,
...
--
-- Name: Risultati id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Risultati" ALTER COLUMN id SET DEFAULT nextval('public."Risultati_id_seq"'::regclass);
...
--
-- Name: Giocatori Giocatori_Nome_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Giocatori"
    ADD CONSTRAINT "Giocatori_Nome_key" UNIQUE ("Nome");
...
--
-- Name: LatestSession LatestSession_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."LatestSession"
    ADD CONSTRAINT "LatestSession_pkey" PRIMARY KEY (id);


--
-- Name: Risultati Risultati_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Risultati"
...
--
-- Name: Risultati risultati_data_ora_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Risultati"
    ADD CONSTRAINT risultati_data_ora_unique UNIQUE (data, ora);
...
\unrestrict NWWw64v2qoTIefrTj37QQca8HmnoNRyzmBBQJdxyYW8JhcLqxEcGe0hMxhKqHfc
